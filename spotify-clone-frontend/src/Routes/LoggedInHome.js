...
//import SongPlayerUI from "../Components/Shared/SongPlayerUI";
...
//       <div className="displayComponent w-full h-9/10 flex flex-col bg-black">
...
//             <div className="leftPanel col-span-3 h-full bg-[#191414] rounded-lg px-2 py-2">
...
//         </div>
//       </div>
//       <div className="songPlayer bg-transparent h-1/10 w-full">
//         <SongPlayerUI />
//       </div>
//     </div>
//   );
